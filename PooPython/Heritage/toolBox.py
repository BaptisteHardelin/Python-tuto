...
"""On place le marteau et le tournevis dans la boite à outils"""
box.add_tool(marteau)
box.add_tool(tournevis)

"""On instancie une vis et on la tourne avec le tournevis et on Affiche la vis avant et après l'avoir serrée"""
vis = Screw()
print(vis)
tournevis.tighten(vis)
print(vis)

"""On instancie un clou et on l'enfonce avec le marteau et on Affiche le clou avant et après l'avoir enfoncé"""
clou = Nail()
print(clou)
...
"""Enlever un outil"""
print("Outils dans la boite",  box.tools)
box.remove_tool(marteau)
print("On a enlevé un marteau...")
print("Outils dans la boite",  box.tools)
